    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form2_accessed_by', models.ManyToManyField(related_name='access_to_form2', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form4_accessed_by', models.ManyToManyField(related_name='access_to_form4', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form3_accessed_by', models.ManyToManyField(related_name='access_to_form3', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form1_accessed_by', models.ManyToManyField(related_name='access_to_form1', to=settings.AUTH_USER_MODEL)),
